...
class EncryptionServiceImplTest {
    ...
    @Test
    fun testDecryptRSA() {
        val cipherText = ""
        ...
        val publicKey = encryptionServiceImpl.toPublicRSAKey(base64EncodedPublicTestKey)

        val privateKey = encryptionServiceImpl.toPrivateRSAKey(base64EncodedPrivateTestKey)
